...
The \textbf{I3S Laboratory} (Sophia Antipolis) is a research center for Computer Science where I spent my time working and learning under the supervision of Mr. Denis Pallez.
...
To fix this, we want to replace the "Explicit" evaluation (manual evaluation like clicking) with an "Implicit" evaluation (subconscious looking).
...
\begin{itemize}
    ...
    \item Our Machine Learning model predicts which image the user should prefer.
\end{itemize}
