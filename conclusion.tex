...
\begin{itemize}
    ...
    \item \textbf{Methodology:} We implemented and compared three distinct approaches: a Heuristic Baseline, Ranking SVM, and LightGBM.
...
Future work should focus on the live integration of this model 
%and the exploration of hybrid systems that combine implicit gaze tracking with occasional explicit user feedback
. Ultimately, this work contributes a significant step towards making human-computer optimization more natural, efficient, and seamless.